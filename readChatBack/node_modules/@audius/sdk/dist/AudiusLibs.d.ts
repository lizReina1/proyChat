...
declare type LibsWormholeConfig = Merge<WormholeConfig, {
...
export declare class AudiusLibs {
     ...
     */
    static configEthWeb3(tokenAddress: string, registryAddress: string, providers: string | string[] | typeof Web3, ownerWallet: string, claimDistributionContractAddress: string, wormholeContractAddress: string): {
        tokenAddress: string;
        registryAddress: string;
        providers: string[] | ((typeof import("web3").default & {
            utils: {
     ...
     * Configures wormhole
     */
    static configWormhole({ rpcHosts, solBridgeAddress, solTokenBridgeAddress, ethBridgeAddress, ethTokenBridgeAddress }: LibsWormholeConfig): WormholeConfig;
    /**
