 ...
 */
export declare const getNStorageNodes: (allNodes: StorageNode[], numNodes?: number, wallet?: string, logger?: Logger) => Promise<string[]>;
export declare const isNodeHealthy: (endpoint: string, logger?: Logger) => Promise<boolean>;
