...
export declare type FlaskFullResponse = Partial<{
...
export declare type ApiHealthResponseData = FlaskFullResponse | CommsResponse | {
    data: unknown;
};
export declare type HealthCheckComms = Partial<{
    healthy: boolean;
    errors: unknown;
...
export declare type HealthCheckResponseData = DeepPartial<{
...
export declare type HealthCheckThresholds = {
    /**
...
export declare type HealthCheckStatusReason = {
