...
export declare type EntityManagerConfigInternal = {
    /**
...
export declare type EntityManagerConfig = Partial<EntityManagerConfigInternal> & {
    /**
     * The DiscoveryNodeSelector service used to get a discovery node to confirm blocks
     */
    discoveryNodeSelector: DiscoveryNodeSelectorService;
};
export declare type EntityManagerService = {
...
export declare type ManageEntityOptions = {
    /**
     * The numeric user id
     */
    userId: number;
